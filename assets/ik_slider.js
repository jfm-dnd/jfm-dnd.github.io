	...
	*/
	Plugin.prototype.onKeyDown = function (event) {
	    ...
	    switch (true) {
	        ...
	        case (event.keyCode == ik_utils.keys.right || event.keyCode == ik_utils.keys.up):
	        ...
	        case (event.keyCode == ik_utils.keys.end):
	            plugin.setValue(plugin.options.maxValue);
	            break;
	       
	        case (event.keyCode == ik_utils.keys.left || event.keyCode == ik_utils.keys.down):
	        ...
	        case (event.keyCode == ik_utils.keys.home):
